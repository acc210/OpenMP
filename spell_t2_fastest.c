...
#pragma omp parallel for schedule(guided, 500) private(j,hash)

//guided, runtime, dynamic, static 

/* guided- comes back and gets a different chunk each time
 * static does it once
 * dynamic does it as many time with the same chunk size 
 * 
 * 
 */
